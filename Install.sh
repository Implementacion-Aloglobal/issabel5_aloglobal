...
name_customer=$(\
      dialog  --backtitle "$BACKTITLE" --title "Ingresa Nombre CLiente Corto para Hostname y descripcion cliente VPN ALOGLOBAL" --no-tags \
